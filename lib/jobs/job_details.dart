...
import 'package:flutter_linkedin_clone/widgets/comments_widgets.dart';
import 'package:fluttertoast/fluttertoast.dart';
import 'package:url_launcher/url_launcher.dart';
import 'package:uuid/uuid.dart';

class JobDetailsScreen extends StatefulWidget {
  JobDetailsScreen({Key? key, required this.uploadedBy, required this.jobID})
      : super(key: key);
...
class _JobDetailsScreenState extends State<JobDetailsScreen> {
  ...
  applyForJob() {
    final Uri params = Uri(
      ...
      path: emailCompany,
      query:
          'subject=Applying for $jobTitle&body=Hello, please attached Resume CV file',
    );
